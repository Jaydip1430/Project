...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@FIREFLY.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 7861991007</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">FIRE <span>FLY</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">FIRE FLY</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our FIRE FLY</h3> 
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img width="150" id="bb"  height="150" src=images/teamb1.jpg class="attachment-full size-full " alt="" loading="lazy" (max-width: 400px) 100vw, 100px />
					</li>
					<li>
					<img width="150" id="bb"  height="150" src=images/teams2.jpg class="attachment-full size-full " alt="" loading="lazy" (max-width: 400px) 100vw, 100px />
						<!-- <img src="images/teams2.jpg" alt=" " class="img-responsive" /> -->
					</li>
					<li>
					<img width="150" id="bb"  height="150" src=images/teams3.jpg class="attachment-full size-full " alt="" loading="lazy" (max-width: 400px) 100vw, 100px />
						<!-- <img src="images/teams3.jpg" alt=" " class="img-responsive" /> -->
					</li>
					<li>
					<img width="150" id="bb"  height="150" src=images/teams4.jpg class="attachment-full size-full " alt="" loading="lazy" (max-width: 400px) 100vw, 100px />
					...
					<div class="tab1">
					<!-- <div>
					 <img width="150" id="bb"  height="150" src=images/bhavesh.jpg class="attachment-full size-full " alt="" loading="lazy" (max-width: 400px) 100vw, 100px />  -->
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 7861991007</p> 
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@FIREFLY.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> 150 ring road, Rajkot, 360001</p>
			...
			<div class="social-bnr-agileits footer-icons-agileinfo">
				...
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3653.2050597739155!2d71.1828031!3d23.0068602!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6a22b70ac8a689f1%3A0x10336fbecf9deafd!2sSidLink%20It%20solutions!5e0!3m2!1sen!2sus!4v1634647178937!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 20 FIREFLY . All Rights Reserved | Design by Hiren , Harshad & Melul <a href="index.php">FIREFLY</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
